...
import constants
from trackers import Player_Tracker,Ball_Tracker, ball_tracker
...
def main():
    ...
    #Detecting Players and Ball Detection
    player_Tracker = Player_Tracker(model_path='yolov8x')
    ball_Tracker = Ball_Tracker(model_path='models/yolo5_last.pt')
    ...
    player_stats_data_df['player_1_average_player_speed'] = player_stats_data_df['player_1_total_shot_speed']/player_stats_data_df['player_2_num_shots']
    player_stats_data_df['player_2_average_player_speed'] = player_stats_data_df['player_2_total_shot_speed']/player_stats_data_df['player_1_num_shots']
