...
def draw_player_stats(output_video_frames, player_stats):
    ...
    for index,row in player_stats.iterrows():
        ...
        avg_1_player_shot_speed = row['player_1_average_shot_speed']
        avg_2_player_shot_speed = row['player_2_average_shot_speed']
        ...
        text = f"{avg_1_player_shot_speed:.1f} km/h    {avg_2_player_shot_speed:.1f} km/h"
